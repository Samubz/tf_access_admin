...
- **WHEN** a request to `GET /api/v1/mobile/residential_property/:id/unit/:unit_id/visit` is made with no `Authorization` header, or an invalid/expired JWT
